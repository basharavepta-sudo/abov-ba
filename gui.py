...
class StyledButton(tk.Canvas):
    ...
    def _draw(self):
        ...
        if self.disabled:
            ...
            fg = Theme.BG_DARK
            border = bg if not self.focused else Theme.TEXT
        else:
        ...
        # Extra focus indicator for accessibility
        if self.focused:
            self._rounded_rect(3, 3, self.width-3, self.height-3, r-1, "", Theme.ACCENT_GLOW)
