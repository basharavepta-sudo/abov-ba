...
class StyledButton(tk.Canvas):
    ...
    def _rounded_rect(self, x1, y1, x2, y2, r, fill, outline):
        ...
        if outline:
            self.create_arc(x1, y1, x1+2*r, y1+2*r, start=90, extent=90, style="arc", outline=outline)
            self.create_arc(x2-2*r, y1, x2, y1+2*r, start=0, extent=90, style="arc", outline=outline)
            self.create_arc(x1, y2-2*r, x1+2*r, y2, start=180, extent=90, style="arc", outline=outline)
            self.create_arc(x2-2*r, y2-2*r, x2, y2, start=270, extent=90, style="arc", outline=outline)
